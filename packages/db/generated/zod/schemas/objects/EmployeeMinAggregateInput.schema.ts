...
export const EmployeeMinAggregateInputObjectSchema: z.ZodType<Prisma.EmployeeMinAggregateInputType> = makeSchema() as unknown as z.ZodType<Prisma.EmployeeMinAggregateInputType>;
export const EmployeeMinAggregateInputObjectZodSchema = makeSchema();
