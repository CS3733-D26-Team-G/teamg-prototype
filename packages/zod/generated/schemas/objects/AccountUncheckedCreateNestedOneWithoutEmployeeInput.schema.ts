...
export const AccountUncheckedCreateNestedOneWithoutEmployeeInputObjectSchema: z.ZodType<Prisma.AccountUncheckedCreateNestedOneWithoutEmployeeInput> = makeSchema() as unknown as z.ZodType<Prisma.AccountUncheckedCreateNestedOneWithoutEmployeeInput>;
export const AccountUncheckedCreateNestedOneWithoutEmployeeInputObjectZodSchema = makeSchema();
