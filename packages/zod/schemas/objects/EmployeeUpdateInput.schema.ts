...
import { AccountUpdateOneWithoutEmployeeNestedInputObjectSchema as AccountUpdateOneWithoutEmployeeNestedInputObjectSchema } from './AccountUpdateOneWithoutEmployeeNestedInput.schema.ts'

const makeSchema = () => z.object({
  uuid: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  accountUsername: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const EmployeeUpdateInputObjectSchema: z.ZodType<Prisma.EmployeeUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.EmployeeUpdateInput>;
export const EmployeeUpdateInputObjectZodSchema = makeSchema();
