...
export const EmployeeFindFirstSelectSchema: z.ZodType<Prisma.EmployeeSelect> = z.object({
...
export const EmployeeFindFirstSelectZodSchema = z.object({
    uuid: z.boolean().optional(),
    account: z.boolean().optional(),
    accountUsername: z.boolean().optional(),
    first_name: z.boolean().optional(),
...
export const EmployeeFindFirstSchema: z.ZodType<Prisma.EmployeeFindFirstArgs> = z.object({ select: EmployeeFindFirstSelectSchema.optional(), include: z.lazy(() => EmployeeIncludeObjectSchema.optional()), orderBy: z.union([EmployeeOrderByWithRelationInputObjectSchema, EmployeeOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmployeeWhereInputObjectSchema.optional(), cursor: EmployeeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmployeeScalarFieldEnumSchema, EmployeeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EmployeeFindFirstArgs>;

export const EmployeeFindFirstZodSchema = z.object({ select: EmployeeFindFirstSelectSchema.optional(), include: z.lazy(() => EmployeeIncludeObjectSchema.optional()), orderBy: z.union([EmployeeOrderByWithRelationInputObjectSchema, EmployeeOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmployeeWhereInputObjectSchema.optional(), cursor: EmployeeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmployeeScalarFieldEnumSchema, EmployeeScalarFieldEnumSchema.array()]).optional() }).strict();