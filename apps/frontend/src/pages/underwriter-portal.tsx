        ...
        <>
            ...
            <Box sx={{
                ...
                <Paper elevation={2} sx={{
                    ...
                    <br /><br />
                    <Typography><b>My Goal:</b> Make informed underwriting decisions quickly and accurately.</Typography>
                    <br />
                ...
                <Box sx={{
                    ...
                    <Paper elevation={2} sx={{
                        ...
                        <ul>
                            <li>Access: Daily</li>
                            <br />
                            <li>Criticality: Very High — inability to access guidelines halts underwriting</li>
                        </ul>
                    </Paper>
                </Box>
                ...
                <Paper elevation={2} sx={{
                    ...
                    >
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Desktop Management Tool"}
                        ...
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"RiskMeter Online"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"ISOnet Website"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                        ...
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Property View"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Coastal Guidelines"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
