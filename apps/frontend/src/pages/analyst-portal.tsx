import {Typography, Avatar, ListItemButton, ListItemText, Paper, Stack, Box} from "@mui/material"
            ...
            <Box sx={{
                ...
                <Paper elevation={2} sx={{
                    ...
                    <Stack alignItems="center">
                        <Avatar variant= "square" sx={{width: 200, height:200,}} ></Avatar>
                        <Typography variant={"h6"}>Business Analyst</Typography>
                    </Stack>
                    <br /><br />
                    <Typography><b>My Goal:</b> Ensure accurate documentation and seamless process integration.</Typography>
                    <br />
                    ...
                    <br /> <br />
                    <Typography sx={{ fontWeight: "bold" }}>I May Think & Say...</Typography>
                    <ul>
                ...
                <Box sx={{
                    ...
                    <Paper elevation={2} sx={{
                        ...
                        <Typography sx={{ fontWeight: "bold" }}>Critical Capabilities (1–5)</Typography>
                        <ul>
                    ...
                    <Paper elevation={2} sx={{
                        ...
                        <Typography sx={{ fontWeight: "bold" }}>Frequency of Access & Criticality</Typography>
                        <ul>
                            <li>Access: Weekly</li>
                            <br />
                            <li>Criticality: High — incorrect workflows disrupt operations</li>
                        </ul>
                        <br />
                        <Typography sx={{ fontWeight: "bold" }}>Content Accessed</Typography>
                        <ul>
                ...
                <Paper elevation={2} sx={{
                    ...
                    >
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"States on Hold"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Forms Knowledge Base"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"IPS (Image & Processing System)"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Underwriting Workstation"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"CPP Rater Resource Site"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"PMS URG"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Kentucky Tax and Tax Exemption Job Aid"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Experience & Schedule Rating Plans"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Error Lookup Tool"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                        <ListItemButton component={"a"} href={"#"}>
                            <ListItemText primary={"Workaround Tool"}
                                          sx={{ '& .MuiListItemText-primary': { color: 'blue' } }}
                            />
                        </ListItemButton>
                    </Stack>
