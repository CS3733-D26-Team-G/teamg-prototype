        ...
        <section className="main-content-form">
            ...
            <div className="main">
                ...
                <form>
                    ...
                    <TextField id="outlined-basic" label="Position" variant="outlined"></TextField>
                    ...
                    <TextField id="outlined-basic" label="Personal Email Address" variant="outlined"></TextField>
                    <TextField id="outlined-basic" label="Corporate Email Address" variant="outlined"></TextField>
